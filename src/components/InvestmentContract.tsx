...
const CompanyInfo = ({ language }) => {
  ...
  return (
    <View style={styles.companyInfo}>
      ...
      <Text style={styles.companyDetail}>{isEnglish ? 'Registration' : 'Immatriculation'}: 12345-DEL</Text>
      <Text style={styles.companyDetail}>{isEnglish ? 'Address' : 'Adresse'}: Silicon Valley, CA 94025</Text>
      ...
      <Text style={styles.companyDetail}>{isEnglish ? 'Represented by' : 'Représenté par'}: John Smith</Text>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          {isEnglish
            ...
            : 'Le présent Accord est régi et interprété conformément aux lois de l\'État de Californie, États-Unis d\'Amérique.'}
        </Text>
      </View>
      ...
      <View style={styles.signatureSection}>
        <View style={styles.signatureBlock}>
          ...
          <Text style={styles.paragraph}>John Smith</Text>
          <Text style={styles.label}>
